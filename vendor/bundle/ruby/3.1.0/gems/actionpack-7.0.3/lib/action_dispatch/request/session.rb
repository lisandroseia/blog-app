  ...
  class Request
    ...
    class Session # :nodoc:
      ...
      class Options # :nodoc:
        ...
        def to_hash() = @delegate.dup
        def values_at(*args) = @delegate.values_at(*args)
      end
      ...
      #   end
      #   # => :bar
      def fetch(key, default = Unspecified, &)
        load_for_read!
        if default == Unspecified
          @delegate.fetch(key.to_s, &)
        else
          @delegate.fetch(key.to_s, default, &)
        end
      end
