  ...
  module Channel
    ...
    module Streams
      ...
      def stream_for(model, callback = nil, coder: nil, &block)
        stream_from(broadcasting_for(model), callback || block, coder:)
      end
      ...
      def worker_pool_stream_handler(broadcasting, user_handler, coder: nil)
        ...
        lambda do |message|
          connection.worker_pool.async_invoke handler, :call, message, connection:
        end
      end
      ...
      def stream_transmitter(handler = identity_handler, broadcasting:)
        ...
        lambda do |message|
          transmit handler.call(message), via:
        end
      end
